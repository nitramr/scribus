...
PropertyWidgetText_OptMargins::PropertyWidgetText_OptMargins(QWidget* parent) : QWidget(parent)
{
	m_item = 0;
	m_ScMW = 0;
...
void PropertyWidgetText_OptMargins::setMainWindow(ScribusMainWindow* mw)
{
	m_ScMW = mw;
...
void PropertyWidgetText_OptMargins::connectSignals()
{
	//Optical Margins
...
void PropertyWidgetText_OptMargins::disconnectSignals()
{
	//Optical Margins
...
void PropertyWidgetText_OptMargins::configureWidgets(void)
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_OptMargins::setDoc(ScribusDoc *d)
{
...
void PropertyWidgetText_OptMargins::setCurrentItem(PageItem *item)
{
...
void PropertyWidgetText_OptMargins::showOpticalMargins(const ParagraphStyle & pStyle)
{
...
void PropertyWidgetText_OptMargins::updateStyle(const ParagraphStyle& newCurrent)
{
	showOpticalMargins(newCurrent);
}

void PropertyWidgetText_OptMargins::handleOpticalMargins()
{
...
void PropertyWidgetText_OptMargins::resetOpticalMargins()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *item = m_item;
...
void PropertyWidgetText_OptMargins::showFirstLinePolicy( FirstLineOffsetPolicy f )
{
	if(f == FLOPFontAscent)
...
void PropertyWidgetText_OptMargins::handleFirstLinePolicy(int radioFlop)
{
...
void PropertyWidgetText_OptMargins::handleTabs()
{
	if (m_doc && m_item)
	{
...
void PropertyWidgetText_OptMargins::handleAppModeChanged(int oldMode, int mode)
{
...
void PropertyWidgetText_OptMargins::handleSelectionChanged()
{
...
void PropertyWidgetText_OptMargins::languageChange()
{
	retranslateUi(this);
}
...
void PropertyWidgetText_OptMargins::changeEvent(QEvent *e)
{
