...
PropertyWidgetText_PathText::PropertyWidgetText_PathText(QWidget* parent) : QWidget(parent)
{
	m_ScMW = 0;
	m_doc  = 0;
	m_item = 0;
...
void PropertyWidgetText_PathText::setMainWindow(ScribusMainWindow* mw)
{
	m_ScMW = mw;
...
void PropertyWidgetText_PathText::connectSignals()
{
...
void PropertyWidgetText_PathText::disconnectSignals()
{
...
void PropertyWidgetText_PathText::configureWidgets(void)
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_PathText::setDoc(ScribusDoc *d)
{
...
void PropertyWidgetText_PathText::setCurrentItem(PageItem *item)
{
...
void PropertyWidgetText_PathText::handlePathDist()
{
...
void PropertyWidgetText_PathText::handlePathFlip()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_PathText::handlePathLine()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_PathText::handlePathOffs()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_PathText::handlePathType()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_PathText::languageChange()
{
...
void PropertyWidgetText_PathText::unitChange()
{
	if (!m_doc)
		return;
...
void PropertyWidgetText_PathText::handleSelectionChanged()
{
...
void PropertyWidgetText_PathText::handleUpdateRequest(int /*updateFlags*/)
{
	// Nothing to do
}
...
void PropertyWidgetText_PathText::changeEvent(QEvent *e)
{
