...
PropertyWidgetText_GlyphStretch::PropertyWidgetText_GlyphStretch(QWidget* parent) : QWidget(parent)
{
	m_item = NULL;
	m_ScMW = NULL;
	m_unitIndex = 0;
...
void PropertyWidgetText_GlyphStretch::setMainWindow(ScribusMainWindow *mw)
{
	m_ScMW = mw;
}

void PropertyWidgetText_GlyphStretch::connectSignals()
{
	// Glyph Scale
...
void PropertyWidgetText_GlyphStretch::disconnectSignals()
{
	// Glyph Scale
...
void PropertyWidgetText_GlyphStretch::configureWidgets(void)
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_GlyphStretch::setDoc(ScribusDoc *d)
{
...
void PropertyWidgetText_GlyphStretch::setCurrentItem(PageItem *item)
{
...
void PropertyWidgetText_GlyphStretch::showTextScaleH(double e)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphStretch::showTextScaleV(double e)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphStretch::handleMinGlyphExtension()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphStretch::handleMaxGlyphExtension()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphStretch::handleTextScaleH()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphStretch::handleTextScaleV()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphStretch::updateCharStyle(const CharStyle& charStyle)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphStretch::updateStyle(const ParagraphStyle& newCurrent)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphStretch::handleSelectionChanged()
{
...
void PropertyWidgetText_GlyphStretch::languageChange()
{
	retranslateUi(this);
}
...
void PropertyWidgetText_GlyphStretch::changeEvent(QEvent *e)
{
