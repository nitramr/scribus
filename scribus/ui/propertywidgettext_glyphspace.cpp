...
PropertyWidgetText_GlyphSpace::PropertyWidgetText_GlyphSpace(QWidget* parent) : QWidget(parent)
{
	m_item = NULL;
	m_ScMW = NULL;
	m_unitIndex = 0;
...
void PropertyWidgetText_GlyphSpace::setMainWindow(ScribusMainWindow *mw)
{
	m_ScMW = mw;
}

void PropertyWidgetText_GlyphSpace::connectSignals()
{
	// Space
...
void PropertyWidgetText_GlyphSpace::disconnectSignals()
{
	// Space
...
void PropertyWidgetText_GlyphSpace::configureWidgets(void)
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_GlyphSpace::setDoc(ScribusDoc *d)
{
...
void PropertyWidgetText_GlyphSpace::setCurrentItem(PageItem *item)
{
...
void PropertyWidgetText_GlyphSpace::showBaseLineOffset(double e)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphSpace::showTracking(double e)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphSpace::handleBaselineOffset()
{
...
void PropertyWidgetText_GlyphSpace::handleMinWordTracking()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphSpace::handleNormWordTracking()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphSpace::handleTracking()
{
	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_GlyphSpace::updateCharStyle(const CharStyle& charStyle)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphSpace::updateStyle(const ParagraphStyle& newCurrent)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_GlyphSpace::handleSelectionChanged()
{
...
void PropertyWidgetText_GlyphSpace::languageChange()
{
	retranslateUi(this);
}
...
void PropertyWidgetText_GlyphSpace::changeEvent(QEvent *e)
{
