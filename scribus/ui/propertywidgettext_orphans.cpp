...
PropertyWidgetText_Orphans::PropertyWidgetText_Orphans(QWidget* parent) : QWidget(parent)
{
	setupUi(this);
...
void PropertyWidgetText_Orphans::connectSignals()
{
...
void PropertyWidgetText_Orphans::disconnectSignals()
{
...
void PropertyWidgetText_Orphans::handleKeepLinesStart()
{
	if (!m_doc) return;
...
void PropertyWidgetText_Orphans::handleKeepLinesEnd()
{
	if (!m_doc) return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_Orphans::handleKeepTogether()
{
	if (!m_doc) return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_Orphans::handleKeepWithNext()
{
	if (!m_doc) return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_Orphans::updateStyle(const ParagraphStyle& newCurrent)
{
	disconnectSignals ();
...
void PropertyWidgetText_Orphans::languageChange()
{
	retranslateUi(this);
}
...
void PropertyWidgetText_Orphans::changeEvent(QEvent *e)
{
