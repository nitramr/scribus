...
PropertyWidgetText_FontFeatures::PropertyWidgetText_FontFeatures(QWidget* parent) : QWidget(parent)
{
	m_item = NULL;
	m_ScMW = NULL;
	setupUi(this);
...
void PropertyWidgetText_FontFeatures::setMainWindow(ScribusMainWindow *mw)
{
	m_ScMW = mw;
}

void PropertyWidgetText_FontFeatures::connectSignals()
{
...
void PropertyWidgetText_FontFeatures::disconnectSignals()
{
...
void PropertyWidgetText_FontFeatures::configureWidgets()
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_FontFeatures::initWidgets()
{
...
void PropertyWidgetText_FontFeatures::setDoc(ScribusDoc *d)
{
...
void PropertyWidgetText_FontFeatures::setCurrentItem(PageItem *item)
{
...
void PropertyWidgetText_FontFeatures::showFontFeatures(QString s, QStringList availableFeatures)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_FontFeatures::disableAllFeatures()
{
	CommonCheck->setChecked(true);
	ContextualCheck->setChecked(true);
	DiscretionaryCheck->setChecked(false);
...
void PropertyWidgetText_FontFeatures::enableFeatures(QStringList fontFeatures)
{
...
quint64 PropertyWidgetText_FontFeatures::featureFlags()
{
	quint64 flags = 0;
...
void PropertyWidgetText_FontFeatures::handleFontFeatures()
{
...
void PropertyWidgetText_FontFeatures::languageChange()
{
	retranslateUi(this);
}

void PropertyWidgetText_FontFeatures::handleSelectionChanged()
{
...
void PropertyWidgetText_FontFeatures::updateCharStyle(const CharStyle& charStyle)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_FontFeatures::updateStyle(const ParagraphStyle& newCurrent)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_FontFeatures::changeEvent(QEvent *e)
{
