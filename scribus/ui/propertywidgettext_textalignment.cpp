...
PropertyWidgetText_TextAlignment::PropertyWidgetText_TextAlignment(QWidget* parent) : QWidget(parent)
{
	m_item = NULL;
	m_ScMW = NULL;
	m_haveItem = false;
...
void PropertyWidgetText_TextAlignment::setMainWindow(ScribusMainWindow *mw)
{
	m_ScMW = mw;
}

void PropertyWidgetText_TextAlignment::connectSignals()
{
	// Emphasize
...
void PropertyWidgetText_TextAlignment::disconnectSignals()
{
	// Emphasize
...
void PropertyWidgetText_TextAlignment::configureWidgets(void)
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_TextAlignment::setDoc(ScribusDoc *d)
{
...
void PropertyWidgetText_TextAlignment::setCurrentItem(PageItem *item)
{
...
void PropertyWidgetText_TextAlignment::showOutlineW(double x)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::showShadowOffset(double x, double y)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::showStrikeThru(double p, double w)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::showTextEffects(int s)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::handleOutlineWidth()
{
...
void PropertyWidgetText_TextAlignment::handleShadowOffs()
{
	if ((m_doc) && (m_item))
	{
...
void PropertyWidgetText_TextAlignment::handleStrikeThru()
{
	if ((m_doc) && (m_item))
	{
...
void PropertyWidgetText_TextAlignment::handleTypeStyle(int s)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
	PageItem *i2 = m_item;
...
void PropertyWidgetText_TextAlignment::showUnderline(double p, double w)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::handleUnderline()
{
	if ((m_doc) && (m_item))
	{
...
void PropertyWidgetText_TextAlignment::showAlignment(int e)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
	bool tmp = m_haveItem;
...
void PropertyWidgetText_TextAlignment::handleVAlign()
{
...
void PropertyWidgetText_TextAlignment::handleAlignment(int a)
{
...
void PropertyWidgetText_TextAlignment::showDirection(int e)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
	bool tmp = m_haveItem;
...
void PropertyWidgetText_TextAlignment::handleDirection(int d)
{
	if (!m_haveDoc || !m_haveItem || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
	Selection tempSelection(this, false);
...
void PropertyWidgetText_TextAlignment::updateCharStyle(const CharStyle& charStyle)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::updateStyle(const ParagraphStyle& newCurrent)
{
	if (!m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
void PropertyWidgetText_TextAlignment::handleSelectionChanged()
{
...
void PropertyWidgetText_TextAlignment::languageChange()
{
	retranslateUi(this);
...
void PropertyWidgetText_TextAlignment::changeEvent(QEvent *e)
{
