...
PropertyWidgetText_ParEffect::PropertyWidgetText_ParEffect(QWidget *parent) : QWidget(parent), m_enhanced(NULL), m_item(NULL), m_ScMW(NULL)
{
	setupUi(this);
...
void PropertyWidgetText_ParEffect::setMainWindow(ScribusMainWindow* mw)
{
	m_ScMW = mw;
...
void PropertyWidgetText_ParEffect::connectSignals()
{
...
void PropertyWidgetText_ParEffect::disconnectSignals()
{
...
void PropertyWidgetText_ParEffect::configureWidgets(void)
{
	bool enabled = false;
	if (m_item && m_doc)
	{
...
void PropertyWidgetText_ParEffect::setDoc(ScribusDoc *doc)
{
...
void PropertyWidgetText_ParEffect::setCurrentItem(PageItem *item)
{
...
*
**********************************************************************/
void PropertyWidgetText_ParEffect::fillPECombo()
{
...
void PropertyWidgetText_ParEffect::enableBullet(bool enable)
{
...
void PropertyWidgetText_ParEffect::enableNum(bool enable)
{
...
void PropertyWidgetText_ParEffect::enableParEffect(bool enable)
{
...
void PropertyWidgetText_ParEffect::enableDropCap(bool enable)
{
...
void PropertyWidgetText_ParEffect::handleParEffectUse()
{
	if (!m_doc || !m_item)
		return;
...
void PropertyWidgetText_ParEffect::fillNumerationsCombo()
{
...
void PropertyWidgetText_ParEffect::fillNumFormatCombo()
{
	numFormatCombo->clear();
	numFormatCombo->addItems(getFormatList());
}

void PropertyWidgetText_ParEffect::handleNumName(QString numName)
{
	if (!m_doc || !m_item)
		return;
	disconnectSignals();
...
void PropertyWidgetText_ParEffect::handleNumFormat(int style)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handleNumLevel(int level)
{
	if (!m_doc || !m_item)
		return;
...
void PropertyWidgetText_ParEffect::handleNumPrefix(QString prefix)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handleNumSuffix(QString suffix)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handleNumStart(int start)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handleDropCapLines(int dcLines)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handlePEOffset(double offset)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handlePEIndent(bool indent)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::handlePECharStyle(QString name)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::fillBulletStrEditCombo()
{
	bulletStrEdit->clear();
...
void PropertyWidgetText_ParEffect::handleBulletStr(QString bulStr)
{
	if (!m_doc || !m_item)
		return;
	ParagraphStyle newStyle;
...
void PropertyWidgetText_ParEffect::openEnhanced()
{
	if (m_enhanced)
		return;
...
void PropertyWidgetText_ParEffect::closeEnhanced(bool show)
{
	if (!m_enhanced || show)
		return;
...
void PropertyWidgetText_ParEffect::on_bulletCharTableButton_toggled(bool checked)
{
...
void PropertyWidgetText_ParEffect::insertSpecialChars(const QString &chars)
{
...
void PropertyWidgetText_ParEffect::unitChange()
{
	if (!m_doc)
		return;
...
void PropertyWidgetText_ParEffect::updateCharStyles()
{
	peCharStyleCombo->updateFormatList();
}

void PropertyWidgetText_ParEffect::showCharStyle(const QString& name)
{
...
void PropertyWidgetText_ParEffect::updateStyle(const ParagraphStyle& newPStyle)
{
...
void PropertyWidgetText_ParEffect::handleAppModeChanged(int oldMode, int mode)
{
...
void PropertyWidgetText_ParEffect::handleSelectionChanged()
{
...
void PropertyWidgetText_ParEffect::handleUpdateRequest(int updateFlags)
{
...
void PropertyWidgetText_ParEffect::handleChanges(PageItem *item, ParagraphStyle &newStyle)
{
	if (m_doc->appMode == modeEditTable)
...
void PropertyWidgetText_ParEffect::languageChange()
{
	fillPECombo();
	retranslateUi(this);
}
...
void PropertyWidgetText_ParEffect::changeEvent(QEvent *e)
{
