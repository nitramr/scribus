...
PropertiesPalette_ShadowOptions::PropertiesPalette_ShadowOptions( QWidget* parent) : QWidget(parent)
{
...
void PropertiesPalette_ShadowOptions::connectSignals(){
...
void PropertiesPalette_ShadowOptions::disconnectSignals(){
...
void PropertiesPalette_ShadowOptions::setMainWindow(ScribusMainWindow* mw)
{
	m_ScMW = mw;
...
void PropertiesPalette_ShadowOptions::setDoc(ScribusDoc *d)
{
...
void PropertiesPalette_ShadowOptions::unsetDoc()
{
	if (m_doc)
	{
		disconnect(m_doc->m_Selection, SIGNAL(selectionChanged()), this, SLOT(handleSelectionChanged()));
...
void PropertiesPalette_ShadowOptions::unsetItem()
{
	m_haveItem = false;
	m_item     = NULL;
...
void PropertiesPalette_ShadowOptions::setCurrentItem(PageItem *i)
{
...
//void PropertiesPalette_ShadowOptions::handleFillColorBox(){
...
//void PropertiesPalette_ShadowOptions::showColor(QString b, double sb)
//{
//	if (!m_doc || !m_item || !m_ScMW || m_ScMW->scriptIsRunning())
//		return;
...
//void PropertiesPalette_ShadowOptions::updateColorList()
//{
...
void PropertiesPalette_ShadowOptions::handleNewValues()
{
	if (m_haveItem)
	{

//		shadow = hasSoftShadow->isChecked();
//		shadowX = softShadowXOffset->value() / m_unitRatio;
//		shadowY = softShadowYOffset->value() / m_unitRatio;
//		shadowR = softShadowBlurRadius->value() / m_unitRatio;
//		shadowS = softShadowShade->value();
//		shadowO = (100 - softShadowOpacity->value()) / 100.0;
...
//void PropertiesPalette_ShadowOptions::setShadowOn(bool isOn){

//	shadow = isOn;

//}

//void PropertiesPalette_ShadowOptions::setShadowOptions(QString color, double X, double Y,  double radius, int shade, double opacity){
...
void PropertiesPalette_ShadowOptions::handleSelectionChanged()
{
	if (!m_haveDoc || !m_ScMW || m_ScMW->scriptIsRunning())
		return;
...
//void PropertiesPalette_ShadowOptions::handleUpdateRequest(int updateFlags)
//{
//	if (updateFlags & reqColorsUpdate)
//		updateColorList();
//}

PageItem* PropertiesPalette_ShadowOptions::currentItemFromSelection()
{
...
void PropertiesPalette_ShadowOptions::languageChange()
{
	disconnectSignals();
...
//void PropertiesPalette_ShadowOptions::unitChange()
//{
//	if (!m_haveDoc)
//		return;
//	m_unitRatio = m_doc->unitRatio();
...
//void PropertiesPalette_ShadowOptions::updateSpinBoxConstants()
//{
//	if (!m_haveDoc)
//		return;
...
void PropertiesPalette_ShadowOptions::changeEvent(QEvent *e)
{
